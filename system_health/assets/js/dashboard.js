...
//These error widgets include both the ERROR COUNT and the RECENT ERROR LOGS
    function errors() {
        $.getJSON("/errors", function(result){
                ...
                var day_link = "https://elasticsearch-us-prod.eastus.cloudapp.azure.com/app/kibana#/discover?_g=(refreshInterval:(pause:!t,value:0),time:(from:now-24h,mode:quick,to:now))&_a=(columns:!(RequestPath,Username,message,StatusCode),filters:!(('$state':(store:appState),meta:(alias:!n,disabled:!f,index:'05010600-3079-11e9-962e-4b467b7ac4f3',key:level,negate:!t,params:(query:Warning,type:phrase),type:phrase,value:Warning),query:(match:(level:(query:Warning,type:phrase))))),index:'05010600-3079-11e9-962e-4b467b7ac4f3',interval:auto,query:(language:lucene,query:error),sort:!('@timestamp',desc))";
                var week_link = "https://elasticsearch-us-prod.eastus.cloudapp.azure.com/app/kibana#/discover?_g=(refreshInterval:(pause:!t,value:0),time:(from:now-7d,mode:quick,to:now))&_a=(columns:!(RequestPath,Username,message,StatusCode),filters:!(('$state':(store:appState),meta:(alias:!n,disabled:!f,index:'05010600-3079-11e9-962e-4b467b7ac4f3',key:level,negate:!t,params:(query:Warning,type:phrase),type:phrase,value:Warning),query:(match:(level:(query:Warning,type:phrase))))),index:'05010600-3079-11e9-962e-4b467b7ac4f3',interval:auto,query:(language:lucene,query:error),sort:!('@timestamp',desc))";
                var month_link = "https://elasticsearch-us-prod.eastus.cloudapp.azure.com/app/kibana#/discover?_g=(refreshInterval:(pause:!t,value:0),time:(from:now-30d,mode:quick,to:now))&_a=(columns:!(RequestPath,Username,message,StatusCode),filters:!(('$state':(store:appState),meta:(alias:!n,disabled:!f,index:'05010600-3079-11e9-962e-4b467b7ac4f3',key:level,negate:!t,params:(query:Warning,type:phrase),type:phrase,value:Warning),query:(match:(level:(query:Warning,type:phrase))))),index:'05010600-3079-11e9-962e-4b467b7ac4f3',interval:auto,query:(language:lucene,query:error),sort:!('@timestamp',desc))";
